...
class visualize_paths():
    ...
    def visualize_paths(self, mode):
        pygame.init()
        #screen = pygame.display.set_mode((400,400), pygame.RESIZABLE)
        self._VARS['surf'] = pygame.display.set_mode((self.dimensions[0], self.dimensions[1]),pygame.RESIZABLE)
...
class darp_area_visualization(object):
    def __init__(self, Assignment_matrix, DroneNo, color, init_robot_pos):
        ...
        pygame.init()
        #screen = pygame.display.set_mode((400,400), pygame.RESIZABLE)
        self._VARS['surf'] = pygame.display.set_mode((dimensions[0], dimensions[1]),pygame.RESIZABLE)
        #self._VARS['surf'] = pygame.display.set_mode((500,500),pygame.RESIZABLE)
        self.checkEvents()
        self._VARS['surf'].fill(GREY)
